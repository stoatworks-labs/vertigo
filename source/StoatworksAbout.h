 ...
 *
 * GENERATED by stoatworks-backend/scripts/sync-about.py on 2026-09-02. Do not
...
namespace stoatworks::about
{
    ...
    inline constexpr auto guide = "https://stoatworks-labs.com/software/vertigo/guide/";
    ...
    inline constexpr auto versionFallback = "v0.1.5";
